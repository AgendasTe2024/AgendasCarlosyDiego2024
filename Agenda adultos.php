...
$consulta = "SELECT * FROM citasa";
$resultado = $conexion->prepare($consulta);
$resultado->execute();
$citasa = $resultado->fetchAll(PDO::FETCH_ASSOC);
?>
...
<body style="background-color: black; color:white;">
  ...
  <center>
    <h1>
      <p> AGENDA DE CITAS EXCLUSIVAMENTE DE LOS PACIENTES ADULTOS</p>
    </h1>
  </center>
    ...
    <div class="row">
      <div class="col-lg-12">
        <table class="table table-vcenter card-table text-center" style="color:white;">
          ...
          <body>
            <?php
            foreach ($citasa as $citasa) {
            ?>
              <tr>
                <td><?php echo $citasa['Unidad'] ?></td>
                <td><?php echo $citasa['Nombre'] ?></td>
                <td><?php echo $citasa['Dia'] ?></td>
                <td><?php echo $citasa['Turno'] ?></td>
              </tr>
            <?php
            }
            ?>
  ...
  <center>
  <div class="dere">
    <a href="CitasFa.php" class="btn btn-primary">Agendar Cita</a>
    <a href="index.html" class="btn btn-primary">Regresar</a><br>
  </div>
  </center>
